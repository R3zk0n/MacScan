...
#ifndef JAVAUTILCOLLECTIONS_UNMODIFIABLELIST_H
#define JAVAUTILCOLLECTIONS_UNMODIFIABLELIST_H
...
@interface JavaUtilCollections_UnmodifiableList : UnmodifiableCollection <JavaUtilList>
