...
#ifndef ORGAPACHELUCENEUTILFSTREVERSEBYTESREADER_H
#define ORGAPACHELUCENEUTILFSTREVERSEBYTESREADER_H
...
@interface OrgApacheLuceneUtilFstReverseBytesReader : BytesReader {
    IOSByteArray *bytes_;
    int pos_;
}
