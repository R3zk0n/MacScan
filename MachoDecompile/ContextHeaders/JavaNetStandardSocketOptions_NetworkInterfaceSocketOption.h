...
#ifndef JAVANETSTANDARDSOCKETOPTIONS_NETWORKINTERFACESOCKETOPTION_H
#define JAVANETSTANDARDSOCKETOPTIONS_NETWORKINTERFACESOCKETOPTION_H

@class SocketOptionImpl;



@interface JavaNetStandardSocketOptions_NetworkInterfaceSocketOption : SocketOptionImpl
