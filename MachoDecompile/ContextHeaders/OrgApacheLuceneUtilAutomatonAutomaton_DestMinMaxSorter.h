...
#ifndef ORGAPACHELUCENEUTILAUTOMATONAUTOMATON_DESTMINMAXSORTER_H
#define ORGAPACHELUCENEUTILAUTOMATONAUTOMATON_DESTMINMAXSORTER_H
...
@interface OrgApacheLuceneUtilAutomatonAutomaton_DestMinMaxSorter : OrgApacheLuceneUtilInPlaceMergeSorter {
    OrgApacheLuceneUtilAutomatonAutomaton *this$0_;
}




-(void)swapOneWithInt:(int)arg0 withInt:(int)arg1 ;
