...
#ifndef LIBCOREIOPOSIX_H
#define LIBCOREIOPOSIX_H
...
-(int)preadWithJavaIoFileDescriptor:(id)arg0 withByteArray:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 withLong:(NSInteger)arg4 ;
-(int)preadBytesWithJavaIoFileDescriptor:(id)arg0 withId:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 withLong:(NSInteger)arg4 ;
-(int)pwriteWithJavaIoFileDescriptor:(id)arg0 withJavaNioByteBuffer:(id)arg1 withLong:(NSInteger)arg2 ;
-(int)pwriteWithJavaIoFileDescriptor:(id)arg0 withByteArray:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 withLong:(NSInteger)arg4 ;
-(int)pwriteBytesWithJavaIoFileDescriptor:(id)arg0 withId:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 withLong:(NSInteger)arg4 ;
...
-(int)readBytesWithJavaIoFileDescriptor:(id)arg0 withId:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 ;
...
-(int)recvfromBytesWithJavaIoFileDescriptor:(id)arg0 withId:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 withInt:(int)arg4 withJavaNetInetSocketAddress:(id)arg5 ;
...
-(int)sendtoBytesWithJavaIoFileDescriptor:(id)arg0 withId:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 withInt:(int)arg4 withJavaNetInetAddress:(id)arg5 withInt:(int)arg6 ;
...
-(int)writeBytesWithJavaIoFileDescriptor:(id)arg0 withId:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 ;
-(int)writevWithJavaIoFileDescriptor:(id)arg0 withNSObjectArray:(id)arg1 withIntArray:(id)arg2 withIntArray:(id)arg3 ;
-(int)getpid;
-(int)getppid;
+(void)throwErrnoExceptionWithNSString:(id)arg0 withInt:(int)arg1 ;
+(int)throwIfMinusOneWithNSString:(id)arg0 withInt:(int)arg1 ;
+(void)updateInetSocketAddressWithJavaNetInetSocketAddress:(id)arg0 withJavaNetInetAddress:(id)arg1 withInt:(int)arg2 ;
