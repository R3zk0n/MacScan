...
#ifndef JAVANIODIRECTBYTEBUFFER_H
#define JAVANIODIRECTBYTEBUFFER_H
...
-(id)initWithJavaNioMemoryBlock:(id)arg0 withInt:(int)arg1 withInt:(int)arg2 withBoolean:(BOOL)arg3 withJavaNioChannelsFileChannel_MapMode:(id)arg4 ;
...
-(void)checkNotFreed;
+(id)copy__WithJavaNioDirectByteBuffer:(id)arg0 withInt:(int)arg1 withBoolean:(BOOL)arg2 ;
