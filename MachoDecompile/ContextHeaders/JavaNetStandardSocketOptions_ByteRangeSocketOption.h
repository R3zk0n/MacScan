...
#ifndef JAVANETSTANDARDSOCKETOPTIONS_BYTERANGESOCKETOPTION_H
#define JAVANETSTANDARDSOCKETOPTIONS_BYTERANGESOCKETOPTION_H

@class SocketOptionImpl;



@interface JavaNetStandardSocketOptions_ByteRangeSocketOption : SocketOptionImpl
